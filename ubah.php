...
<?php
    ...
    $sql = "UPDATE buku SET nis='$nis', nama_siswa='$nama_siswa' , jenis_kelamin='$jenis_kelamin' , alamat='$alamat' , id_jurusan='$id_jurusan', nama_jurusan='$nama_jurusan'  WHERE id_siswa = '$id_siswa'";
